...
const KakiLanjutan = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/kaki_lanjutan/burpees.gif"),
      moveTypee: "BURPEES",
      duration: "x 10",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_lanjutan/squats.gif"),
      moveTypee: "SQUATS",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_lanjutan/cursty_lunges.gif"),
      moveTypee: "CURSTY LUNGES",
      duration: "x 15",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_lanjutan/jumping_squats.gif"),
      moveTypee: "JUMPING SQUATS",
      duration: "X 15",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_lanjutan/calf_stretch.gif"),
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan12", {
