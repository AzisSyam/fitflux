...
const CalfStretchKakiLanjutan = ({ route }) => {
      ...
      if (timer === 20) {
        const { sound: move } =
          await Audio.Sound.createAsync(
            require("../../../../../assets/sounds/kaki_lanjutan/calf_stretch.mp3")
          );
        setSound(move);
  ...
  useEffect(() => {
    ...
    if (timer === 0) {
      ...
      navigation.navigate("HasilKakiLanjutan", {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerGift}>
        <Image
          source={require("../../../../../assets/gif/kaki_lanjutan/calf_stretch.gif")}
          style={styles.gift}
        />
      </View>
...
export default CalfStretchKakiLanjutan;
