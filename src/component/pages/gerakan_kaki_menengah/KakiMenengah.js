...
const KakiMenengah = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/kaki_menengah/jumping_jacks.gif"),
      moveTypee: "JUMPING JACKS",
      duration: "x 30",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_menengah/squats.gif"),
      moveTypee: "SQUATS",
      duration: "x 12",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_menengah/lunges.gif"),
      moveTypee: "LUNGES",
      duration: "x 14",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_menengah/sumo_squat.gif"),
      moveTypee: "SUMO SQUATS",
      duration: "X 14",
    },
    {
      imageSource: require("../../../../assets/gif/kaki_menengah/calf_stretch.gif"),
