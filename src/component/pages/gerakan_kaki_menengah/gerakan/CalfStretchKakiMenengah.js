...
const CalfStretchKakiMenengah = ({ route }) => {
      ...
      if (timer === 20) {
        const { sound: move } =
          await Audio.Sound.createAsync(
            require("../../../../../assets/sounds/kaki_menengah/calf_stretch.mp3")
          );
        setSound(move);
  ...
  useEffect(() => {
    ...
    if (timer === 0) {
      ...
      navigation.navigate("HasilKakiMenengah", {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerGift}>
        <Image
          source={require("../../../../../assets/gif/kaki_menengah/calf_stretch.gif")}
          style={styles.gift}
        />
      </View>
...
export default CalfStretchKakiMenengah;
