...
const PerutPemula = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/perut_pemula/jumping_jacks.gif"),
      moveTypee: "JUMPING JACKS",
      duration: "00:20",
    },
    {
      imageSource: require("../../../../assets/gif/perut_pemula//mountain_climber.gif"),
      moveTypee: "MOUNTAIN CLIMBER",
      duration: "x 16",
    },
    {
      imageSource: require("../../../../assets/gif/perut_pemula/leg_raises.gif"),
      moveTypee: "LEG RAISES",
      duration: "x 16",
    },
    {
      imageSource: require("../../../../assets/gif/perut_pemula/heel_touch.gif"),
      moveTypee: "HEEL TOUCH ",
      duration: "X 20",
    },
    {
      imageSource: require("../../../../assets/gif/perut_pemula/cobra_stretch.gif"),
      moveTypee: "COBRA STRETCH",
      duration: "00:20",
    },
  ];
  return (
    <View style={styles.container}>
      <TouchableOpacity
        onPress={() => navigation.navigate("PemulaDashboard")}
      ...
      <View style={styles.cardTop}>
        <Image
          source={require("../../../../assets/images/perutExercise.png")}
        ...
        <View style={styles.cardBottom}>
          <View style={styles.typeLevel}>
            <Text style={styles.cardTextTop1}>Perut</Text>
          ...
          <View style={styles.cardBottomCalorieTime}>
            <View style={styles.cardBottomCalorie}>
              ...
              <View style={styles.cardBottomCalorieTimeText}>
                <Text style={styles.cardTextRegular}>100</Text>
            ...
            <View style={styles.cardNavigationBottomTime}>
              ...
              />
              <View style={styles.cardBottomCalorieTimeText}>
                <Text style={styles.cardTextRegular}>10</Text>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan", {
