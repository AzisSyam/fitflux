  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerImage}>
        <Image
          source={require("../../../../assets/images/perut_pemula/hasil_perut_pemula.png")}
          style={styles.image}
        />
      </View>
      <View style={styles.containerText}>
        ...
        <View style={styles.containerTextBottom}>
          <Text style={styles.textMainBottom}>Perut</Text>
          <View style={styles.circle}></View>
          <Text style={styles.textMainBottom}>Pemula</Text>
        </View>
      </View>
      <View style={styles.containerInformation}>
        ...
        <View style={styles.containerInformationMiddle}>
          <Text style={styles.textInformation}>100</Text>
...
export default HasilPerutPemula;
