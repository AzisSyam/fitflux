...
const ChestStretchLenganLanjutan = ({ route }) => {
      ...
      if (timer === 20) {
        const { sound: move } =
          await Audio.Sound.createAsync(
            require("../../../../../assets/sounds/lengan_lanjutan/chest_stretch.mp3")
          );
        setSound(move);
  ...
  useEffect(() => {
    ...
    if (timer === 0) {
      ...
      navigation.navigate("HasilLenganLanjutan", {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerGift}>
        <Image
          source={require("../../../../../assets/gif/lengan_lanjutan/chest_stretch.gif")}
          style={styles.gift}
        />
      </View>
...
export default ChestStretchLenganLanjutan;
