...
const LenganMenengah = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/lengan_menengah/arm_raises.gif"),
      moveTypee: "ARM RAISES",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_menengah/triceps_dips.gif"),
      moveTypee: "TRICEP DIPS",
      duration: "x 10",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_menengah/diamond_push_up.gif"),
      moveTypee: "DIAMOND PUSH UP",
      duration: "x 6",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_menengah/diagonal_plank.gif"),
      moveTypee: "DIAGONAL PLANK",
      duration: "X 10",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_menengah/wall_push_up.gif"),
      moveTypee: "WALL PUSH UP",
      duration: "X 12",
    },
  ];
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan8", {
