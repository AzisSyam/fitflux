...
const PerutMenengah = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/perut_menengah/jumping_jacks.gif"),
      moveTypee: "JUMPING JACKS",
      duration: "x 25",
    },
    {
      imageSource: require("../../../../assets/gif/perut_menengah/sit_up.gif"),
      moveTypee: "SIT UP",
      duration: "x 16",
    },
    {
      imageSource: require("../../../../assets/gif/perut_menengah/heel_touch.gif"),
      moveTypee: "HEEL TOUCH",
      duration: "x 26",
    },
    {
      imageSource: require("../../../../assets/gif/perut_menengah/mountain_climber.gif"),
      moveTypee: "MOUNTAIN CLIMBER",
      duration: "X 20",
    },
    {
      imageSource: require("../../../../assets/gif/perut_menengah/cobra_stretch.gif"),
    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardTop}>
        ...
        <View style={styles.cardBottom}>
          <View style={styles.typeLevel}>
            ...
            <Text style={styles.cardTextTop1}>Menengah</Text>
          </View>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan2", {
