...
const PerutLanjutan = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/perut_lanjutan/jumping_jacks.gif"),
      moveTypee: "JUMPING JACKS",
      duration: "x 30",
    },
    {
      imageSource: require("../../../../assets/gif/perut_lanjutan/sit_up.gif"),
      moveTypee: "SIT UP",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/perut_lanjutan/biscyle_crunche.gif"),
      moveTypee: "BISCYCLE CRUNCHES",
      duration: "x 24",
    },
    {
      imageSource: require("../../../../assets/gif/perut_lanjutan/v_up.gif"),
      moveTypee: "V-UP",
      duration: "X 20",
    },
    {
      imageSource: require("../../../../assets/gif/perut_lanjutan/cobra_stretch.gif"),
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        onPress={() => navigation.navigate("LanjutanDashboard")}
          ...
          <View style={styles.cardBottomCalorieTime}>
            <View style={styles.cardBottomCalorie}>
              ...
              <View style={styles.cardBottomCalorieTimeText}>
                <Text style={styles.cardTextRegular}>150</Text>
            ...
            <View style={styles.cardNavigationBottomTime}>
              ...
              />
              <View style={styles.cardBottomCalorieTimeText}>
                <Text style={styles.cardTextRegular}>15</Text>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan3", {
