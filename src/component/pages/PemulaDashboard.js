...
const PemulaDashboard = () => {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require("../../../assets/images/pemula_navbar.png")}
...
export default PemulaDashboard;
