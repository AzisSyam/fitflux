...
const LanjutanDashboard = () => {
  ...
  const cardExercise = [
    // Data card 1
    {
      ...
      level: "Lanjutan",
      duration: "18 Menit",
      navigateTo: "NestedScreens3",
      params: {
        screen: "PerutLanjutan",
      },
    },
    // Data card 2
    {
    ...
    // Data card 3
    {
      ...
      level: "Lanjutan",
      duration: "18 Menit",
      navigateTo: "NestedScreens9",
      params: {
        screen: "LenganLanjutan",
      },
    },
    // Data card 4
    {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require("../../../assets/images/lanjutan_navbar.png")}
      ...
      <View style={styles.mainContainer}>
        <Image
          source={require("../../../assets/images/jenisLatihanLanjutan.png")}
...
export default LanjutanDashboard;
