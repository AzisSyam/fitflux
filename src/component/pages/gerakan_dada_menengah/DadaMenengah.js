...
const DadaMenengah = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/dada_menengah/jumping_jacks.gif"),
      moveTypee: "JUMPING JACKS",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/dada_menengah/knee_push_up.gif"),
      moveTypee: "KNEE PUSH UP",
      duration: "x 10",
    },
    {
      imageSource: require("../../../../assets/gif/dada_menengah/push_up.gif"),
      moveTypee: "PUSH UP",
      duration: "x 12",
    },
    {
      imageSource: require("../../../../assets/gif/dada_menengah/decline_push_up.gif"),
      moveTypee: "DECLINE PUSH UP",
      duration: "X 10",
    },
    {
      imageSource: require("../../../../assets/gif/dada_menengah/cobra_stretch.gif"),
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() => {
          hitungDurasi();
          navigation.navigate("PersiapanGerakan5", {
