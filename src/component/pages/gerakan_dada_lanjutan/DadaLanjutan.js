...
const DadaLanjutan = () => {
  ...
  const moveTypeCard = [
    ...
    {
      imageSource: require("../../../../assets/gif/dada_lanjutan/arm_circles.gif"),
      moveTypee: "ARM CIRCLES",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/dada_lanjutan/burpees.gif"),
      moveTypee: "BURPEES",
      duration: "x 10",
    },
    {
      imageSource: require("../../../../assets/gif/dada_lanjutan/diamond_push_up.gif"),
      moveTypee: "DIAMNOND PUSH UP",
      duration: "X 12",
    },
    {
      imageSource: require("../../../../assets/gif/dada_lanjutan/chest_stretch.gif"),
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan6", {
