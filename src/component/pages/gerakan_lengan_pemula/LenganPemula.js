...
const LenganPemula = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/lengan_pemula/arm_circles.gif"),
      moveTypee: "ARM CIRCLES",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_pemula/leg_barbell_curl_left.gif"),
      moveTypee: "LEG BARBELL CURL LEFT",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_pemula/leg_barbell_curl_right.gif"),
      moveTypee: "LEG BARBELL CURL RIGHT",
      duration: "x 10",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_pemula/floor_tricep_dips.gif"),
      moveTypee: "FLOOR TRICEP DIPS",
      duration: "X 12",
    },
    {
      imageSource: require("../../../../assets/gif/lengan_pemula/chest_stretch.gif"),
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan7", {
