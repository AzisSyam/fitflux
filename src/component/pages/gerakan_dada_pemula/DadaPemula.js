...
const DadaPemula = () => {
  ...
  const moveTypeCard = [
    {
      imageSource: require("../../../../assets/gif/dada_pemula/jumping_jacks.gif"),
      moveTypee: "JUMPING JACKS",
      duration: "x 20",
    },
    {
      imageSource: require("../../../../assets/gif/dada_pemula/incline_push_up.gif"),
      moveTypee: "INCLINE PUSH UP",
      duration: "x 10",
    },
    {
      imageSource: require("../../../../assets/gif/dada_pemula/push_up.gif"),
      moveTypee: "PUSH UP",
      duration: "x 8",
    },
    {
      imageSource: require("../../../../assets/gif/dada_pemula/tricep_dips.gif"),
      moveTypee: "TRICEP DIPS",
      duration: "X 10",
    },
    {
      imageSource: require("../../../../assets/gif/dada_pemula/cobra_stretch.gif"),
    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardTop}>
        ...
        <View style={styles.cardBottom}>
          <View style={styles.typeLevel}>
            <Text style={styles.cardTextTop1}>Dada</Text>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          navigation.navigate("PersiapanGerakan4", {
